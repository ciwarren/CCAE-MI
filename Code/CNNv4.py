...
datasets = [
    {
        'name':'Brain Classified Reconstruction Test',
        'training_path':'C:\\Users\\charl\\Documents\\College\\Spring 2022\\Thesis\\Data\\Hemorrage\\Train',
        'np_training_path':'Numpy\\Brain Classified CT Train.npy',
        'test_path':'C:\\Users\\charl\\Documents\\College\\Spring 2022\\Thesis\\Data\\Hemorrage\\Test',
        'np_test_path':'Numpy\\Brain Classified CT Test.npy',
        'IMG_SIZE':512
    },
    {
        'name':'Chest Classified Reconstruction Test',
        'training_path':'C:\\Users\\charl\\Documents\\College\\Spring 2022\\Thesis\\Data\\Chest XRAY - Classified\\chest_xray\\agnostic_train',
        'np_training_path':'Numpy\\Chest Classified Xray Train.npy',
        'test_path':'C:\\Users\\charl\\Documents\\College\\Spring 2022\\Thesis\\Data\\Chest XRAY - Classified\\chest_xray\\agnostic_test',
        'np_test_path':'Numpy\\Chest Classified Xray Test.npy',
        'IMG_SIZE':512
    },
    {
        'name':'CT Brain Scans',
        ...
        'np_test_path':'Numpy\\Test-CT-Brain-Scans.npy',
        'IMG_SIZE':512
    },
    {
        ...
        'np_test_path':'Numpy\\Test-MRI-Brain-Scans.npy',
        'IMG_SIZE':256
    },
    {
        'name':'Chest Xray',
        'training_path':'C:\\Users\\charl\\Documents\\College\\Spring 2022\\Thesis\\Data\\chest_xray\\train',
        'np_training_path':'Numpy\\Chest Xray Train.npy',
        'test_path':'C:\\Users\\charl\\Documents\\College\\Spring 2022\\Thesis\\Data\\chest_xray\\test',
        'np_test_path':'Numpy\\Chest Xray Test.npy',
        'IMG_SIZE':512
    },
    
    {
        'name':'COVID CT Scans',
        'training_path':'C:\\Users\\charl\\Documents\\College\\Spring 2022\\Thesis\\Data\\COVIDx CT\\train',
        'np_training_path':'Numpy\\Training-COVID_CT.npy',
        'test_path':'C:\\Users\\charl\\Documents\\College\\Spring 2022\\Thesis\\Data\\COVIDx CT\\test',
        'np_test_path':'Numpy\\Test-COVID_CT.npy',
        'IMG_SIZE':512
...
for data_dict in datasets:
    ...
    loss=[keras.losses.MeanSquaredError(),ssim_loss]
    loss_weights= [.25, .75]
    autoencoder.compile(optimizer=opt, loss=loss, loss_weights=loss_weights, metrics=[psnr,'mse',ssim_loss])
    autoencoder.summary()
    callbacks = [keras.callbacks.EarlyStopping(patience=10, restore_best_weights=True),
                keras.callbacks.ModelCheckpoint("Model\\" + data_dict['name'] + ' CNNv4.model', save_freq='epoch')]
    ...
    autoencoder.save("Model\\" + data_dict['name'] + ' CNNv4.model')