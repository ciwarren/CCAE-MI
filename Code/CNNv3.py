...
for data_dict in datasets:
    ...
    autoencoder.compile(optimizer=opt, loss=loss, loss_weights=loss_weights, metrics=[psnr,'binary_crossentropy','mse',ssim_loss])
    autoencoder.summary()
    callbacks = [keras.callbacks.EarlyStopping(patience=10, restore_best_weights=True),
                keras.callbacks.ModelCheckpoint("Model\\" + data_dict['name'] + ' CNNv3.model', save_freq='epoch')]
    ...
    autoencoder.save("Model\\" + data_dict['name'] + ' CNNv3.model')